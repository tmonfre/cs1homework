...
def draw():
    ...
    # if a start_vertex is selected, draw its vertex red
    if start_vertex != None:
        dictionary[start_vertex].draw_vertex(red[0], red[1], red[2])

    # if a goal_vertex is selected, draw its vertex red
    if goal_vertex != None:
...
start_graphics(draw, mouse_press=mousepress, mouse_move=mousemove, width=WINDOW_WIDTH, height=WINDOW_HEIGHT, title="Map of Dartmouth")